...
- monitorar volume de voos atrasados e alertas abertos no dashboard;
- validar latência de tela observando tempo entre trigger e atualização no frontend.
...
- painel com métricas históricas (eventos/min, p95 de endpoints críticos);
